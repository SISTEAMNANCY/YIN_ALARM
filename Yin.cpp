#include "Yin.h"
#include "Arduino.h"
void Yin::initialize(int yinSampleRate,int yinBufferSize,float yinthreshold){
...
Yin::Yin(int yinSampleRate,int yinBufferSize, float yinthreshold){
	initialize(yinSampleRate,yinBufferSize,yinthreshold);
}
...
float Yin::getPitch(int32_t* buffer){
	int tauEstimate = -1;
...
void Yin::difference(int32_t* buffer){
	int index;
	int tau;
	float delta;
